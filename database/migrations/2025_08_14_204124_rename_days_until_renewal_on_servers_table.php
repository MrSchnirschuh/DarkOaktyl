...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('servers')->select('id', 'days_until_renewal')->orderBy('id')->chunk(100, function ($servers) {
    ...
    public function down(): void
    {
        ...
        DB::table('servers')->select('id', 'renewal_date')->orderBy('id')->chunk(100, function ($servers) {
            foreach ($servers as $server) {
