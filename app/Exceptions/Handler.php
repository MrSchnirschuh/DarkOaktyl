...
final class Handler extends ExceptionHandler
{
     ...
     */
    private const DarkOaktyl_RULE_STRING = 'DarkOaktyl\_rules\_';
    ...
    public function render($request, \Throwable $e): Response
    {
        ...
        //
        // @see https://github.com/DarkOaktyl/panel/pull/1468
    ...
    public function invalidJson($request, ValidationException $exception): JsonResponse
    {
        ...
        $errors = Collection::make($exception->errors())->map(function ($errors, $field) use ($codes, $exception) {
            ...
            foreach ($errors as $key => $error) {
                $meta = [
                    'source_field' => $field,
                    'rule' => str_replace(self::DarkOaktyl_RULE_STRING, 'p_', Arr::get(
                        $codes,
