...
class ThemePaletteService
{
    ...
    private function buildCanonicalPalette(array $colors, string $mode, array $referenceTokens = []): array
    {
        ...
        $fallbacks = [
            ...
            'secondary_light' => '#E6E2DC',
            'background_dark' => '#141414',
            'background_light' => '#F8F6F3',
            'headers_dark' => '#171717',
            'headers_light' => '#EFEDE9',
            'sidebar_dark' => '#18181B',
            'sidebar_light' => '#F4F1EC',
            'body_dark' => '#171717',
            'body_light' => '#FDFCFA',
            'text_primary_dark' => '#F5F5F5',
            'text_primary_light' => '#1C1917',
            'text_secondary_dark' => '#D4D4D8',
            'text_secondary_light' => '#44403C',
            'muted_dark' => '#A1A1AA',
            'muted_light' => '#78716C',
            'accent_primary_light' => '#22C55E',
            'accent_primary_dark' => '#16A34A',
