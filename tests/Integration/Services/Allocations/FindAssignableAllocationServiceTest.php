...
namespace DarkOak\Tests\Integration\Services\Allocations;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('DarkOak.client_features.allocations.range_start', 0);
        config()->set('DarkOak.client_features.allocations.range_end', 0);
    }
    ...
    public function testNewAllocationIsCreatedIfOneIsNotFound()
    {
        ...
        config()->set('DarkOak.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('DarkOak.client_features.allocations.range_start', 5000);
        config()->set('DarkOak.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('DarkOak.client_features.allocations.range_start', 'hodor');
        config()->set('DarkOak.client_features.allocations.range_end', 10);
        ...
        config()->set('DarkOak.client_features.allocations.range_start', 10);
        config()->set('DarkOak.client_features.allocations.range_end', 'hodor');
