...
**Game panel & billing & E-Mail & Detailed Theme system — fast, secure, and customizable**

---

## Overview

DarkOaktyl is a modern, high-performance **game server management panel** built on **Jexpanel** and **Pterodactyl Panel**, offering enhanced security, Highly Detailed customization, Email System To send Coupons and Informations, and integrated billing—supporting Stripe and PayPal—right out of the box.

## Features

- Advanced authentication and security setups
- Highly Costomizalble Themes with light, dark and system mode, also with automatic activation on date.  
- Integrated billing system (Stripe + PayPal) with Coupns and E-Mail Intigarion
