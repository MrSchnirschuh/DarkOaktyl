    ...
    return (
        <div className="space-y-4 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Card>
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-muted-foreground">Nicht Zugewiesen</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-between">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="flex gap-2 flex-wrap">
                            <Badge className="bg-blue-500 text-xs">Technisch: {stats.by_category.technical}</Badge>
                            <Badge className="bg-green-500 text-xs">Abrechnung: {stats.by_category.billing}</Badge>
