    ...
    return (
        ...
        >
            <div className={'mt-4'}>
                ...
                <p className={'text-theme-muted text-sm mt-1'}>Provide a name for this server group.</p>
            </div>
            <div className={'mt-2'}>
                ...
                ></InputField>
                <p className={'text-theme-muted text-sm mt-1'}>This is the hex value of the group color.</p>
            </div>
        </Dialog.Confirm>
    );
};
