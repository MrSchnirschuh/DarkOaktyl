    ...
    return (
        ...
        >
            <div className={'flex justify-between space-x-2'}>
                <p className={'my-auto text-xs font-bold text-[var(--theme-text-secondary)]'}>
                ...
                <div className={'inline-flex'}>
                    <p className={'my-auto mr-2 text-xs font-bold text-[var(--theme-text-secondary)]'}>
...
const Table = ({ children }: { children: ReactNode[] }) => {
    ...
    return (
        <div className={'relative overflow-x-auto'}>
            ...
            <table className={'w-full text-left text-sm text-[var(--theme-text-primary)]'}>{children}</table>
        </div>
    );
};
